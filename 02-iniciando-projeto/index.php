...
<body>
    ...
    <main class="main_content">
        <div class="main_slide j_slide">
            <a href="#" title="" class="j_slide_item"><img src="Uploads/featured-02.jpg" alt="" title=""></a>
            <?php 
                for ($i = 1; $i < 4; $i++) {
            ?>
                    <a href="#" title="" class="j_slide_item d_none"><img src=<?= "Uploads/featured-0{$i}.jpg"; ?> alt="" title=""></a>
            <?php
                }
            ?>
                    ...
                    <div class="pdt_gallery_list pdt_gallery_featured">
                        <article class="pdt_gallery_item flex-2">
                            ...
                            <header class="pdt_gallery_item_desc">
                                <h2 class="pdt_gallery_item_title">Calça Moletom Confort Mama Latina</h2>
                                <div class="pdt_gallery_item_price">
